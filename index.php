...
try {
        ...
        $smarty->assign('mas_vendidos', $mas_vendidos);
        $smarty->assign('proveedores_constantes', $proveedores_constantes);
        $smarty->assign('productos_poco_stock', $productos_poco_stock);
